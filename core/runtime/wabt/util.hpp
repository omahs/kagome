...
namespace kagome::runtime {
  ...
  inline WabtOutcome<void> wabtValidate(
      const wabt::Module &module, const RuntimeContext::ContextParams &config) {
    ...
    return wabtTry([&](wabt::Errors &errors) {
      return wabt::ValidateModule(&module, &errors, features);
    });
  }
